...
app.get("/foundation", function (req, res) {
  res.render("foundation", { warning: '' });
})


// for sucess page

app.get("/sucees", function (req, res) {
  res.render("sucees", { warning: '' });
})

// for about page

app.get("/about", function (req, res) {
  res.render("about", { warning: '' });
})


// for finaldonate page

// app.get("/finaldonate", function (req, res) {
//   res.render("/finaldonate", { warning: '' });
// })


// for RegisterLoginDonar page
